...
| Editable text demo | `src/Sample/Flutter.Net/EditableTextDemoPage.cs` | `dart_sample/lib/editable_text_demo_page.dart` | verify-runtime | Baseline input flow parity: controllers, enable/disable toggle, clear action, and live value summary. |
